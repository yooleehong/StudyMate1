...
<body>
	<div class="container">
    <form id="frm" name="frm" method="POST" action="/StudyMate/streaming/webcam/create.do">
	<input type="hidden" id="studyGroupIdx" name="studyGroupIdx" value="${studyGroupIdx}"/>
        ...
        <a href="/StudyMate/streaming/webcam/board.do?idx=${studyGroupIdx}&${ pagination.queryString }" class="btn" id="list">CAM LIST</a>
    </form>
