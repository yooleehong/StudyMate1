...
<script type='text/javascript' src='../../resources/streaming/jwplayer.js'></script>
   ...
   <!DOCTYPE html>
    ...
    <head>
     ...
     <meta http-equiv="Content-Type" content="text/html; charset=UTF-8"> 
      ...
      <script>
      function camserver(){
         window.open('setting.do', 'webcamServer');    //캠 설정 페이지[10월5일 수정] title 안보냄
      }
      </script>
        
        </head>
   <body onload="camserver();">
   ...
   <div class="container">
      ...
      <div id='mediaspace'>없음</div>
         ...
         </script>      <!-- [10월5일수정]캠방 만들시 title말고 id입력으로 변경 -->
            <br>
            <button class="btn" onclick=" location.href ='/StudyMate/streaming/webcam/end.do?idx=${webcam.idx}'">방송종료</button> 
