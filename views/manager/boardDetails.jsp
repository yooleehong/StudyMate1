...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
   ...
   <div class="container">
		        ...
		        <br><br><br><br>
		        <center>
	 <button type="button" class="btn btn-danger" style="width: 5cm; height: 1cm;  border-radius: 20px;" id="delete" data-url="boardelete.do?idx=${ board.idx }&${ pagination.queryString }">삭제하기</button> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	 <button type="button" class="btn btn-primary" style="width: 5cm; height: 1cm;  border-radius: 20px;" onclick=" location.href ='/StudyMate/manager/groupComments.do?idx=${ board.idx }&${ pagination.queryString }'">댓글보기</button>
					</center>
