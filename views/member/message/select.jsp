...
<script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
	...
	/*쪽지*/
		...
		$.ajax({
			type: "POST",
			url : "/StudyMate3/studyManageController",
			dataType : "JSON",
	...
	function form_input(a){
		document.suhoform.userTo.value=a;
		$( "#dialog" ).dialog( "close" ) ;
	}
	$('#massege_submit').click(function(){
		event.preventDefault();	//action을 이용한 폼의 이동을 막아줌
...
<body>
 ...
 <button type="button" class="btn btn-info btn-lg" id="myModal" style="margin-left: 76%;">send</button>
		...
		<ul class="jq_accordion_hover list_menu4">
			...
			<div class="jq_hide cont" style="width: 800px;">
			<div style="width: 100%; text-align: center; margin-left: 19%; margin-top: 27%;">
			    <img src="/StudyMate/resources/images/icon-main.png" style="width: 100%; max-width: 760px; vertical-align: middle" />
			</div>
			</div></div></li>
		</ul>
		<!-- 리스트(ul) 아코디언(click)// -->
